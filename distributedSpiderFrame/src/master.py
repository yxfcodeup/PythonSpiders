...
tools_path = _WORK_DIR_ + "/src/tools"
...
class TaskService(service_pb2.TaskServiceServicer) :
    def sendTask(self , request , context) :
        ...
        _TASKS_ , new_task = _MSP_.run(_TASKS_ , client_ip , request.req , request.return_task , request.return_json , request.remark_json)
        return service_pb2.tReply(task_info=new_task)
